...
| [`empire-git`](plugins/empire-git/README.md)           | Git workflow: parallel worktree lifecycle (`open`, `close`, `merge`, `list`, `cleanup`, `help`), `pr-description` and `pr-comment-reply` templating, and gated `pr-merge`. |
