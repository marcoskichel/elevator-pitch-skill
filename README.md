...
| Plugin                                               | What it does                                                                                                                               |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [`empire`](plugins/empire-meta/README.md)            | Meta bundle. Installs `empire-git`, `empire-team`, `empire-product`, and `empire-agents` together.                                         |
...
| [`empire-agents`](plugins/empire-agents/README.md)   | Bundled fallback subagents: code review, paradigm specialists (FP, concurrency, types), domain experts (blockchain, AI), research roles.   |
